...
- [ ] **Navegación**: Configuración de react-router-dom con al menos una ruta dinámica (ej. /detalle/:id). *(Nota: Actualmente no hay una ruta de detalle dinámico, solo rutas principales).*
